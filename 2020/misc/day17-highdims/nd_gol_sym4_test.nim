...
var NEIGBOURS_MEMO: Table[Sym, seq[(Sym,int)]]
k = 8
for a6 in 0..k:
    for a5 in 0..k-a6:
        for a4 in 0..k-a6-a5:
            for a3 in 0..k-a6-a5-a4:
                for a2 in 0..k-a6-a5-a4-a3:
                    for a1 in 0..k-a6-a5-a4-a3-a2:
                        ...
                        let cell = [a0,a1,a2,a3,a4,a5,a6]
                        NEIGBOURS_MEMO[cell.pack] = cell.pack.getNeighbours
...
proc getStackNeighbours(stack: Stack): CountTable[Sym] =
    ...
    for a in stack:
        for (b, weight) in NEIGBOURS_MEMO[a]:
            result.inc(b, weight)
